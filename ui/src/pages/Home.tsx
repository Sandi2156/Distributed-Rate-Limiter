            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Manage your rate limiting configurations
                </p>
              </div>
            </div>
              ...
              <CardContent className="flex items-center justify-center py-16">
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-gray-300 mb-8 max-w-md text-lg leading-relaxed">
                    Secure, scalable, and intelligent rate limiting for your
                    APIs. Log in to start managing your configurations.
                  </p>
                  <Button
                    onClick={handleLogin}
            ...
            <Card className="backdrop-blur-sm bg-gray-800/80 border-gray-700 shadow-2xl">
              <CardContent className="flex items-center justify-center py-16">
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-gray-300 mb-8 max-w-md text-lg leading-relaxed">
                    You haven't registered any APIs yet. Start by adding your
                    first API and configure rate limiting to protect your
                    endpoints.
                  </p>
                  <Button
                    onClick={handleRegisterApi}
