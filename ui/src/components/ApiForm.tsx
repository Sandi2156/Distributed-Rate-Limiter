...
import type { CreateApiRequest, UpdateApiRequest, ApiRegistration } from '@/services/apiService';
...
export default function ApiForm({ open, onOpenChange, onSubmit, api, isLoading = false }: ApiFormProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {api ? 'Update your API registration details.' : 'Add a new API to your rate limiter.'}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting || isLoading}>
                {isSubmitting ? 'Saving...' : api ? 'Update API' : 'Register API'}
              </Button>
            </DialogFooter>
          </form>
        </Form>
